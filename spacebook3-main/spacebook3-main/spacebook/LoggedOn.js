        ...
        return (
            ...
            { BringData ?(
                    ...
                    <Tab.Group>
                        ...
                        <Tab.Screen name="FriendsScreen" component={UpdateAccount} options={{
                            tabBarLabel: 'Requests', tabBarIcon: ({ color }) =>
                                (<MaterialCommunityIcons name="add-user" color={color} size={26} />),
                        }} />
                        <Tab.Screen name="Search" component={UpdateAccount} options={{
                            tabBarLabel: 'profile', tabBarIcon: ({ color }) =>
                                (<ion-icon name="find" color={color} size={26} />),
                        }} />
                    </Tab.Group>
